...
open class FillableLoader: UIView {
    ...
    */
    open static func showLoaderWithPath(_ path: CGPath, onView: UIView? = nil) -> Self {
    ...
    :returns: The loader that's already being showed
    */
    open static func showProgressBasedLoaderWithPath(_ path: CGPath, onView: UIView? = nil) -> Self {
    ...
    */
    open static func createLoaderWithPath(path thePath: CGPath, onView: UIView? = nil) -> Self {
    ...
    :returns: The created loader
    */
    open static func createProgressBasedLoaderWithPath(path thePath: CGPath, onView: UIView? = nil) -> Self {
        let loader = self.init()
    ...
    internal func initialSetup(_ view: UIView? = nil) {
        //Setting up frame
        var window = view
        ...
        imgVW = UIImageView(frame:CGRect(x: 0, y: 0, width: 75, height: 75))
        imgVW?.center = self.center
        imgVW!.image = UIImage(named:"LoaderLogo")
    ...
    internal func addPath(_ thePath: CGPath) {
        let bounds = thePath.boundingBox
        ...
        path = thePath.copy(using: &transformation)
    }
    ...
    */
    ...
    internal func startswinging() {
        ...
        swingAnimation.delegate = self as? CAAnimationDelegate
